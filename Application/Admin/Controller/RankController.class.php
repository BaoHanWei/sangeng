...
class RankController extends AdminController
{
    ...
    public function editRank($id = null)
    {
        ...
        if (IS_POST) {
            ...
            $data['rule_content'] = $_POST['rule_content'];
            $model = D('rank');
            if ($data['title'] == '') {
            ...
            $builder
                ...
                ->keyEditor('rule_content','申请头像规则',null,'all')
                ->data($rank)
    ...
    public function userChangeRank($id = null, $uid = '', $reason = '', $is_show = '', $rank_id = '')
    {
        if (IS_POST) {
            ...
            $builder
                ...
                ->keyText('reason', L('_RELATED_REASONS_'))
                ->keyRadio('is_show', L('_IS_SHOWN_ON_THE_RIGHT_SIDE_OF_THE_NICKNAME_'), null, array(1 => L('_YES_'), 0 => L('_NO_')))
                ->keySelect('rank_id', L('_TITLE_NUMBER_'), null, $rank_ids)
                ->data($data)
