...
class IndexController extends Controller{
    ...
    function _initialize()
    {
        ...
        array_push($menu_list['left'], array('tab' => 'myNews', 'title' => L('_MY_CONTRIBUTIONS_'), 'href' =>U('News/index/my')));
    ...
    public function index($page=1)
    {
        ...
        foreach($list as &$val){
            $val['user']=query_user(array('avatar32','space_url','nickname'),$val['uid']);
        }
        unset($val);
        /* 模板赋值并渲染模板 */
