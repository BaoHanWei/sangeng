...
//dump($data);
    ...
    public function event($page = 1, $r = 10)
    {
        ...
        $builder->title(L('_CONTENT_MANAGE_'))
            ...
            ->keyId()->keyLink('title', L('_TITLE_'), 'Event/Index/detail?id=###')->keyUid()->keyCreateTime()->keyStatus()->keyMap('is_recommend', L('_RECOMMEND_YES_OR_NOT_'), array(0 => L('_YES_'), 1 => L('_NOT_')))
            ->data($list)
