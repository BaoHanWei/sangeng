...
<!--顶部导航之后的钩子，调用公告等 end-->
  ...
  <a href="<?php echo U('Blog/column/detail',array('id'=>$data['id']));?>" class="column_list_link" target="_blank">
        <div class="column_c">
					    ...
					    <div class="blog_category">
				            <ul class="category_list tracking-ad" data-mod="popu_257">
				            	<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
		                           <a href="<?php echo U('Blog/index/index', array('category' => $vo['id']));?>" class="<?php $array=explode('_',$vo['title']);echo $array[1]; ?>" target="_blank">
		                           		<?php echo $array[0]; ?>
		                           </a>
		                        </li><?php endforeach; endif; else: echo "" ;endif; ?>            
				            </ul>
				         ...
				         <div>
				          ...
				          <div>
					          <ul class="TOP_OSCER">
						        <li><a href="https://my.oschina.net/xxiaobian" target="_blank">
						        	<img src="https://static.oschina.net/uploads/user/714/1428332_100.jpg?t=1400110163000" alt="小小编辑" title="小小编辑" class="LargePortrait" align="absmiddle">
						        	<span class="name">小小编辑</span></a></li>
						      </ul>
						  	</div>
						  	<div style="clear:both"></div>
						  </div>
