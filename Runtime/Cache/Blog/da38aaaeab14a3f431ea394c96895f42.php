                    ...
                    <?php if(!empty($now_category)): ?><div class="common_block_title"><?php echo ($now_category["title"]); ?>
                        ...
                        <?php else: ?>
                         ...
                         <!-- <?php echo L('_BLOG_VIEW_');?> -->
                         	<ul class="blog-tabs">
							    <li  class="tab <?php if($ordertype=='recommend'){ ?>active <?php } ?>"><h1><a href="<?php echo U('Blog/index/index',array('ordertype'=>'recommend','category'=>$_GET['category']));?>">最新推荐</a></h1></li>
							    <li  class="tab <?php if($ordertype=='todayhot'){ ?>active <?php } ?>"><h1><a href="<?php echo U('Blog/index/index',array('ordertype'=>'todayhot','category'=>$_GET['category']));?>">今日热门</a></h1></li>
							    <li  class="tab <?php if($ordertype=='weekhot'){ ?>active <?php } ?>"><h1><a href="<?php echo U('Blog/index/index',array('ordertype'=>'weekhot','category'=>$_GET['category']));?>">本周热门</a></h1></li>
							    <li  class="tab <?php if($ordertype=='newblog'){ ?>active<?php } ?>"><h1><a href="<?php echo U('Blog/index/index',array('ordertype'=>'newblog','category'=>$_GET['category']));?>">最新博客</a></h1></li>
							</ul>
                         </div><?php endif; ?>
                    <div>
                        <section id="contents" class="blog-list">
                            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="box item">
    <div class="box-fl">
        <a href="<?php echo ($data["user"]["space_url"]); ?>" style="display:block;">
            <img class="blog-author" load="loaded" src="<?php echo ($data["user"]["avatar64"]); ?>" ucard="<?php echo ($data["uid"]); ?>">
        </a>
    </div>
    <div class="box-aw">
        <header class="box vertical blog-title-box">
        ...
        <section class="blog-brief text-gradient"><?php echo ($data["description"]); ?></section>
        <footer class="box vertical blog-footer-box">
            <span><?php echo ($data["user"]["nickname"]); ?></span>
            <span>发布于</span>
            <span><?php echo (friendlydate($data["create_time"])); ?></span><span>阅读(<?php echo ($data["view"]); ?>)</span>
        </footer>
    </div>
</div><?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php else: ?>
                                <div style="font-size:1em;padding:2em 0;color: #ccc;text-align: center">该类型下没有文章~</div><?php endif; ?>
                        </section>
            ...
            <div class="col-xs-3" style="width:300px;">
                ...
                <?php echo W('Common/Adv/render',array(array('name'=>'index_bottom_top','type'=>1,'width'=>'340px','height'=>'120px','margin'=>'10px 0 0 0','title'=>'博客首页右侧最底部广告')));?>
                 <div class="common_block_border event_right">
	                 <div>
					    <h1 style="color:#6a6a6a;border-bottom:1px solid #ddd;font-size:16px;line-height:35px;">博客分类</h1>
					    <div class="blog_category">
				            <ul class="category_list tracking-ad" data-mod="popu_257">
				            	<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo['id']==$cid){echo "class='active'";} ?> >
		                           <a href="<?php echo U('Blog/index/index', array('category' => $vo['id']));?>" class="<?php $array=explode('_',$vo['title']);echo $array[1]; ?>">
		                           		<?php echo $array[0]; ?>
		                           </a>
		                        </li><?php endforeach; endif; else: echo "" ;endif; ?>            
				            </ul>
				         ...
				         <div>
				          <h1 style="color:#6a6a6a;border-bottom:1px solid #ddd;font-size:16px;line-height:35px;">本周最受欢迎 TOP</h1>
				          <div>
					          <ul class="TOP_OSCER">
						        ...
						        <li><a href="https://my.oschina.net/u/1584569" target="_blank"><img src="https://static.oschina.net/uploads/user/792/1584569_100.jpg?t=1414902936000" alt="liuzhengyang" title="liuzhengyang" class="LargePortrait" align="absmiddle"><span class="name">liuzhengyang</span></a></li>
						        <li><a href="https://my.oschina.net/wangzhenchao" target="_blank"><img src="https://static.oschina.net/uploads/user/1423/2846411_100.jpg?t=1468051245000" alt="zhenchao" title="zhenchao" class="LargePortrait" align="absmiddle"><span class="name">zhenchao</span></a></li>
						        <li><a href="https://my.oschina.net/JasonZhang" target="_blank"><img src="https://static.oschina.net/uploads/user/83/166585_100.jpg?t=1455612636000" alt="Jason-ZH" title="Jason-ZH" class="LargePortrait" align="absmiddle"><span class="name">Jason-ZH</span></a></li>
						        <li><a href="https://my.oschina.net/qiangdada" target="_blank"><img src="https://static.oschina.net/uploads/user/1456/2912341_100.png?t=1473453284000" alt="qiangdada" title="qiangdada" class="LargePortrait" align="absmiddle"><span class="name">qiangdada</span></a></li>
						        <li><a href="https://my.oschina.net/tudouatudou" target="_blank"><img src="https://static.oschina.net/uploads/user/1448/2896879_100.jpg?t=1472811008000" alt="王练" title="王练" class="LargePortrait" align="absmiddle"><span class="name">王练</span></a></li>
						        <li><a href="https://my.oschina.net/sexgirl" target="_blank"><img src="https://static.oschina.net/uploads/user/58/116366_100.jpg?t=1348021411000" alt="涩女郎" title="涩女郎" class="LargePortrait" align="absmiddle"><span class="name">涩女郎</span></a></li>
						        <li><a href="https://my.oschina.net/moziqi" target="_blank"><img src="https://static.oschina.net/uploads/user/688/1376052_100.jpg?t=1419055382000" alt="executor" title="executor" class="LargePortrait" align="absmiddle"><span class="name">executor</span></a></li>
						        <li><a href="https://my.oschina.net/huangxiujie" target="_blank"><img src="https://static.oschina.net/uploads/user/506/1012086_100.jpg?t=1476021971000" alt="秀杰" title="秀杰" class="LargePortrait" align="absmiddle"><span class="name">秀杰</span></a></li>
						      </ul>
						  	</div>
						  	<div style="clear:both"></div>
						  </div>
						  <div>
						   <h1 style="color:#6a6a6a;border-bottom:1px solid #ddd;font-size:16px;line-height:35px;">本周最勤奋 TOP</h1>
				          <div>
					          <ul class="TOP_OSCER">
						        <li><a href="https://my.oschina.net/xxiaobian" target="_blank"><img src="https://static.oschina.net/uploads/user/714/1428332_100.jpg?t=1400110163000" alt="小小编辑" title="小小编辑" class="LargePortrait" align="absmiddle"><span class="name">小小编辑</span></a></li>
						        <li><a href="https://my.oschina.net/u/1584569" target="_blank"><img src="https://static.oschina.net/uploads/user/792/1584569_100.jpg?t=1414902936000" alt="liuzhengyang" title="liuzhengyang" class="LargePortrait" align="absmiddle"><span class="name">liuzhengyang</span></a></li>
