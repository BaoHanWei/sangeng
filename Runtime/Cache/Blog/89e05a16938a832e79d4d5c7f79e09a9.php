                ...
                <div class="common_block_border">
                    ...
                    <?php if(!empty($now_category)): ?><div class="common_block_title"><?php echo ($now_category["title"]); ?>
                            <div class="pull-right children_news">
                                <?php if(is_array($now_category['_'])): $i = 0; $__LIST__ = $now_category['_'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?>&nbsp;&nbsp;<a href="<?php echo U('Blog/column/index',array('category'=>$cat['id']));?>" style="text-decoration: underline;color: #949494;"><?php echo ($cat["title"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                        </div>
                        <?php else: ?>
                         ...
                         <!-- <?php echo L('_BLOG_VIEW_');?> -->
                         	<ul class="blog-tabs">
							    <li  class="tab <?php if($ordertype=='recommend'){ ?>active <?php } ?>"><h1><a href="<?php echo U('Blog/index/index',array('ordertype'=>'recommend','category'=>$_GET['category']));?>">优秀专栏推荐</a></h1></li>
							</ul>
                         </div><?php endif; ?>
                    <div>
                        <section id="contents" class="blog-list">
                            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="column_list comumn_new  tracking-ad">
   <?php if(time()-strtotime($data['modify_time']) <= 86400*30){ ?>
        <span class="time_new"><?php echo date('m-d',strtotime($data['modify_time'])); ?> 更新</span>
    <?php } ?>
  <div style="background-image:url(<?php echo ($data["logo_url"]); ?>)" class="column_bg"></div>
  <a href="<?php echo U('Blog/column/show',array('id'=>$data['first_document']));?>" class="column_list_link" target="_blank">
        <div class="column_c">
          <p class="column_list_p"><?php echo ($data["project_name"]); ?></p>
          <div class="column_list_b" style="display: none;">
            <div class="column_list_b_l fl" style="margin-left: 20px;"><i class="icon icon-file-text-o" style="color:#fff"></i><span>19</span></div>
            <div class="column_list_b_r fr" style="margin-right: 10px;"><i class="icon icon-eye-open" style="color:#fff"></i><span>3479</span></div>
          </div>
        </div>
   </a>
</div><?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php else: ?>
                                <div style="font-size:1em;padding:2em 0;color: #ccc;text-align: center">该类型下没有专栏~</div><?php endif; ?>
                        </section>
					    ...
					    <div class="blog_category">
				            <ul class="category_list tracking-ad" data-mod="popu_257">
				            	<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo['id']==$cid){echo "class='active'";} ?>>
		                           <a href="<?php echo U('Blog/column/index', array('category' => $vo['id']));?>" class="<?php $array=explode('_',$vo['title']);echo $array[1]; ?>">
		                           		<?php echo $array[0]; ?>
		                           </a>
		                        </li><?php endforeach; endif; else: echo "" ;endif; ?>            
				            </ul>
				         ...
				         <div>
				          ...
				          <div>
					          <ul class="TOP_OSCER">
					          	<?php if(is_array($hotcolumn)): $i = 0; $__LIST__ = $hotcolumn;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="" target="_blank">
						        	<img src="<?php echo ($vo["logo_url"]); ?>" alt="<?php echo ($vo["project_name"]); ?>" title="<?php echo ($vo["project_name"]); ?>" class="LargePortrait" align="absmiddle">
						        	<span class="name"><?php echo ($vo["project_name"]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						      </ul>
						  	</div>
						  	<div style="clear:both"></div>
						  </div>
