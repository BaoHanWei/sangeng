...
<div class="container common_block_border" style="min-height: 700px">
	<div class="row">
		<div class="col-xs-9">
			<h2>
				<i class="icon-tasks"></i><?php echo L("_HOT_ISSUES_");?>
			</h2>
			<div class=" clearfix">
				<div class="question_list" style="padding: 0 5px">
   ...
   <div class="qa-rank">
    ...
    <div class="summary">
        ...
        <?php } ?>
...
</section><?php endforeach; endif; else: echo "" ;endif; ?> <?php else: ?>
					...
					<div class="text-right"><?php echo getPagination($totalCount,20);?></div>
				</div>
			</div>
		</div>
		<div class="col-xs-3"><?php echo W('Question/RightBlock/recommend');?></div>
	</div>
</div>
