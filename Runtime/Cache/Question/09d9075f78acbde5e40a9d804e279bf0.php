   ...
   <div class="qa-rank">
    ...
    <div class="summary">
        ...
        <?php } ?>
                            ...
                            <?php else: ?>
                            <div style="font-size:3em;padding:2em 0;color: #ccc;text-align: center"><?php echo L("_NO_QUESTION_YO_WITH_WAVE_");?></div><?php endif; ?>
            ...
            <div class="col-xs-3">
                <a href="<?php echo U('Question/Index/edit');?>" class="upload-app"><i></i>我要提问</a>
                <?php echo W('Question/RightBlock/recommend');?>
            </div>
        </div>
    </div>
    </div>
