            ...
            <div class="col-xs-12">
                <div class="questions">
                    <div class="common_block_border margin-bottom-15">
                        <div class="tags" style="padding: 15px;">
                            ...
                            <?php if(is_array($parent)): $i = 0; $__LIST__ = $parent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Question/Index/questions',array('category'=>$type['id']));?>" data-id="<?php echo ($type['id']); ?>" class="ptype <?php if($question_cate == $type['id']): ?>active<?php endif; ?>">
                                <?php echo ($type["title"]); ?>
                                </a><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                        <?php if(is_array($child)): $i = 0; $__LIST__ = $child;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(!empty($vo)){ ?>
                            <div class="tags" style="padding: 7px;"> <a><?php echo ($title); ?></a></div>
                            <?php } endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                    <?php if(is_array($child)): $i = 0; $__LIST__ = $child;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(!empty($vo)){ ?>
                        <div class="common_block_border chile_type" id="type_<?php echo ($key); ?>" style="margin-top: -10px; ">
                            <div class="tags" style="padding: 7px;">
                                <?php if(is_array($vo)): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i; if($type['pid']==$question_cate){ ?>
                                    <a href="<?php echo U('Question/Index/questions',array('category'=>$type['id']));?>" <?php if($question_cate == $type['id']): ?>class="active"<?php endif; ?>>
                                    <?php echo ($type["title"]); ?>
                                    </a>
                                    <?php } endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                ...
                <div class="common_block_border clearfix">
                    <div class="question_list" style="padding:0 20px">
                        <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><section class="stream-list__item">
   <div class="qa-rank">
    ...
    <div class="summary">
        ...
        <?php } ?>
                            ...
                            <?php else: ?>
                            <div style="font-size:3em;padding:2em 0;color: #ccc;text-align: center"><?php echo L("_THIS_TYPE_OF_NO_PROBLEM_YO_WITH_WAVE_");?></div><?php endif; ?>
