        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="common_block_border clearfix">
                    <div style="font-size: 16px;margin-left: 24px;">标签：<span><?php echo ($search_keywords); ?></span></div>
   ...
   <div class="qa-rank">
    ...
    <div class="summary">
        ...
        <?php } ?>
                            ...
                            <?php else: ?>
                            <div style="font-size:3em;padding:2em 0;color: #ccc;text-align: center"><?php echo L("_NO_PROBLEM_TO_SEARCH_WITH_WAVE_");?>
                                    <a class="" href="<?php echo U('question/index/edit',array('title'=>$search_keywords));?>">
                                        <i class="icon-edit"></i><?php echo L("_PUT_QUESTIONS_TO_");?>
                                    </a>
                            </div><?php endif; ?>
