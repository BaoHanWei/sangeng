...
<div class="panel-main" style="float:left;">
    ...
    <div class="main-title">
        <h2>
            <?php echo L("_EXPRESSION_PACKAGE_LIST_");?>
        </h2>
    </div>
    <div class="with-padding">
        <div class="fl">
            <a href="<?php echo U('admin/expression/add');?>" class="btn"><?php echo L("_UPLOAD_A_NEW_LOOK_");?></a>
        </div>
    </div>
    <!-- 数据表格 -->
    <div class="with-padding">
        <table class="table table-bordered table-striped ">
            ...
            <thead>
            <tr>
                <th><?php echo L("_CHINESE_NAME_");?></th>
                <th><?php echo L("_TITLE_");?></th>
                <th><?php echo L("_EXPRESSION_QUANTITY_");?></th>
                <th><?php echo L("_STATE_");?></th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$e): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="<?php echo U('admin/expression/expressionlist',array('name'=>$e['pkg_name']));?>"><?php echo ($e['pkg_title']); ?></a></td>
                    <td><a href="<?php echo U('admin/expression/expressionlist',array('name'=>$e['pkg_name']));?>"><?php echo ($e['pkg_name']); ?></a></td>
                    <td><?php echo ($e['count']); ?></td>
                    <td><?php echo ($e['status']?L('_ENABLE_WITH_SINGLE_'):L('_DISABLE_WITH_SINGLE_')); ?></td>
                    <td>
                        <?php if($e['pkg_name'] != 'miniblog'){ ?>
                        <a href="<?php echo U('admin/expression/editpackage',array('name'=>$e['pkg_name']));?>"><?php echo L("_EDIT_");?></a>&nbsp;|&nbsp;<a class="ajax-get" href="<?php echo U('admin/expression/delpackage',array('name'=>$e['pkg_name']));?>"><?php echo L("_DELETE_");?></a>
                        <?php } ?>
                    </td>
