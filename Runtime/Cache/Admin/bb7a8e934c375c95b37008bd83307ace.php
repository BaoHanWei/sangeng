...
<div class="panel-main" style="float:left;">
    ...
    <div class="clearfix row with-padding">
        <div class="col-xs-10">
            <a class="btn" href="<?php echo U('add',array('pid'=>I('get.pid',0)));?>"><?php echo L('_ADD_WITH_SPACE_');?></a>
            <button class="btn ajax-post confirm" url="<?php echo U('del');?>" target-form="ids"><?php echo L('_DELETE_WITH_SPACE_');?></button>
            <a class="btn" href="<?php echo U('import',array('pid'=>I('get.pid',0)));?>"><?php echo L('_IMPORT_');?></a>
        ...
        <div class="col-xs-2">
            <div class="search-form fr cf">
                <div class="sleft">
                    ...
                    <a class="btn btn-default" href="javascript:;" id="search" url="/index.php?s=/admin/menu/index/pid/10050.html"><i
