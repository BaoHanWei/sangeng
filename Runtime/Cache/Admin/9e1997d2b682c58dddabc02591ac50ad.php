...
<div class="main-title">
        <h2><?php echo L("_USER_GROUP_MEMBERSHIP_");?></h2>
</div>
<div class="tab-wrap">
    <div class="with-padding clearfix">
        <div class="col-xs-10">
            <ul class="nav nav-secondary">
                ...
                <li><a href="<?php echo U('AuthManager/accessUser',array('group_name'=>I('group_name') ,'group_id'=> I('group_id')));?>"><?php echo L("_FRONT_DESK_ACCESS_AUTHORIZATION_");?></a></li>
                <li class="active"><a href="javascript:;"><?php echo L("_MEMBER_DELEGATION_");?></a></li>
    ...
    <thead>
		...
		<th class=""><?php echo L("_LAST_LOGIN_IP_");?></th>
    ...
    <tbody>
		<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('AuthManager/removeFromGroup?uid='.$vo['uid'].'&group_id='.I('group_id'));?>" class="ajax-get"><?php echo L("_RELEASE_AUTHORITY_");?></a>
            ...
            <div class="col-xs-2 pull-right">
                <form class="add-user" action="<?php echo U('addToGroup');?>" method="post" enctype="application/x-www-form-urlencoded" >
                    <div class="input-group ">
                        <input class="text input-4x form-control" type="text" name="uid" placeholder="<?php echo L("_PLEASE_ENTER_UID_");?>,<?php echo L("_COMMA_SEPARATED_IN_ENGLISH_");?>">
                        <input type="hidden" name="group_id" value="<?php echo I('group_id');?>">
                    <span class="input-group-btn">
                         <button type="submit" class="btn ajax-post" target-form="add-user"><?php echo L("_NEW_GROWTH_WITH_SPACE_");?></button>
                    </span>
