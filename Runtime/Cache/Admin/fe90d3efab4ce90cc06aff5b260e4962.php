...
<div class="panel-main" style="float:left;">
    ...
    <iframe id="market" src="http://os.opensns.cn/index.php?s=/appstore.html" name="main" width="100%" height="100%"
            frameborder="0" scrolling="yes" style="overflow: visible;bottom: 0;position: absolute;top: 0"></iframe>

    <form id="install_form" action="<?php echo U('Admin/Cloud/install');?>" method="post">
        <input id="install_token" type="hidden" name="token">
        <input id="install_cookie" type="hidden" name="cookie">
    </form>
    <script>

        var website_title = "<?php echo modC('WEB_SITE_NAME','','config');?>";
