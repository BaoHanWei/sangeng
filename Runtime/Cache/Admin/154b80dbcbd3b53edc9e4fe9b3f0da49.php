...
<div class="panel-main" style="float:left;">
    ...
    <div class="clearfix with-padding row">
        <div class="col-xs-10">
            <a class="btn" href="<?php echo U('add');?>"><?php echo L('_ADD_WITH_SPACE_');?></a>
            <a class="btn ajax-post confirm" url="<?php echo U('del');?>" target-form="ids" ><?php echo L('_DELETE_WITH_SPACE_');?></a>
            <button class="btn list_sort" url="<?php echo U('sort?group='.I('group'),'','');?>"><?php echo L('_SORT_');?></button>
            <!-- 高级搜索 -->
        </div>
        <div class="col-xs-2">
