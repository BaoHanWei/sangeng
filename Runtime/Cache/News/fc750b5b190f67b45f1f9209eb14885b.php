...
<!--顶部导航之后的钩子，调用公告等 end-->
        ...
        <div class="row">
            <div class="col-xs-8">
                <div class="common_block_border">
                    <div class="common_block_title"><?php echo L('_MY_CONTRIBUTIONS_');?></div>
    ...
    <?php if($data['cover'] != 0): ?><div class="col-xs-4">
        ...
        <div class="col-xs-8">
            <div>
                <h3 class="title text-more" style="width: 100%;font-size: 15px">
        ...
        <div class="col-xs-12">
            ...
            <div>
                ...
                <?php if($data['status'] == -1): ?><br/>
                    <span class="reason"><?php echo L('_FAULT_REASON_');?>：<?php echo ((isset($data['reason']) && ($data['reason'] !== ""))?($data['reason']):L('_NONE_')); ?></span><?php endif; ?>
