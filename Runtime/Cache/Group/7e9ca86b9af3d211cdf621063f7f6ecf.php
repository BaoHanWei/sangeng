    ...
    <div class="col-xs-8">
        <div class="common-block group_info">
            <header>
                ...
                <i class="icon-list-ul icon-border-circle"></i>&nbsp; <?php echo L('_DISCOVERY_');?> &nbsp;
                    ...
                    <?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="clearfix">
                            ...
                            <div class="col-xs-8">
                                ...
                                <p>
                                    ...
                                    <?php if($vo['flag']): else: ?>
                                        <a data-role="group_attend" data-group-id="<?php echo ($vo["id"]); ?>"
                                           class="">+<?php echo L('_JOIN_');?></a><?php endif; ?>
                                </p>
                            </div>
