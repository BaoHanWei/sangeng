    ...
    <script type="text/javascript" src="/Application/Group/Static/js/common.js"></script>
        ...
        <div class="col-xs-12">
            <div class="fourm-top common_block_border" style="padding: 15px 20px;margin: -15px;margin-top: 0;margin-bottom: 15px">
                <h4>
                    <?php if($isEdit): echo L('_EDIT_'); echo L('_POST_');?>
                        <?php else: ?>
                        <?php echo L('_POSTING_'); echo L('_NEW_POST_'); endif; ?>
                </h4>
                <hr/>
                <section id="contents">
                    <form action="<?php echo U('Group/Index/doEdit');?>" method="post" class="ajax-form" id="edit-article-form" >
                        <input type="hidden" name="post_id" value="<?php echo ($post["id"]); ?>"/>
                        <input id="group_id" type="hidden" name="group_id" value="<?php echo ($group["id"]); ?>" />
                        <div class="row">
                            <!-- 帖子分类 -->
                            <div class="col-sm-3 col-xs-12">
                                <p>
                                    <select class="form-control" name="category">
                                        <option value="0"><?php echo L('_PLEASE_SELECT_'); echo L('_CATEGORY_');?></option>
                                        <?php if(is_array($post_cate)): $i = 0; $__LIST__ = $post_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i; $selected = $category['id'] == $post['cate_id'] ? 'selected' : ''; ?>
                                            <option value="<?php echo ($category["id"]); ?>"
                                            <?php echo ($selected); ?>><?php echo (htmlspecialchars($category["title"])); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </p>
                            </div>
                            <div class="col-sm-9 col-xs-12">
                                <p>
                                    <input id="title" type="text" name="title" placeholder="<?php echo L('_TITLE_');?>" value="<?php echo ($post["title"]); ?>"
                                           class="form-control"/>
                        ...
                        <p>
                            ...
                            <?php echo W('Common/Ueditor/editor',array('contentEditor','content',$post['content'],'100%','250px',$config));?>
                        </p>
                        <p>&nbsp;</p>
                        <p class="pull-right">
                            ...
                            <span id="submit-content">
                                   ...
                                   <?php echo L('_SUBMIT_');?> Ctrl+Enter
                        ...
                        <p>
                            <a class="btn btn-large btn-primary" onclick="history.go(-1)">
                                ...
                                <?php echo L('_RETURN_'); echo L('_POST_'); echo L('_LIST_');?>
                            </a>
                        </p>
                    </form>
                </section>
