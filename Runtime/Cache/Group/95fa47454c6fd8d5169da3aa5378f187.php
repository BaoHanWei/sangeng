...
<div class="main-wrapper">
    ...
    <div class="clearfix common_block_border">
        <div class="row group_block_title">
            <div class="col-md-8 col-sm-8 col-xs-8" style="margin-top: 5px;">
                <?php if($tip){ ?>
                <?php echo (get_nickname($tip)); echo L('_DE_POST_');?>
                <?php }else{ ?>
                <?php echo L('_SEARCH_TITLE_');?> <span style="color: red"><?php echo ($_REQUEST["keywords"]); ?></span>&nbsp;
                &nbsp;
                <small><?php echo ($totalCount); ?> <?php echo L('_PIECE_');?></small>
                <?php } ?>
            </div>
        ...
        <div class="col-xs-12">
            <section id="contents">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix item">
    <div class="col-xs-2">
