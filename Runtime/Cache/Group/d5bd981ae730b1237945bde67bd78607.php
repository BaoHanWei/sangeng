...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="col-xs-8">
        <div class="common-block group_info">
            <header>
            <i class="icon-list-ul icon-border-circle"></i>&nbsp; <?php echo L('_BEST_POST_');?> &nbsp;
                            ...
                            <div class="col-xs-10">
                                <div class="item-heading">
                                   <!-- <div class="pull-right"><a href="###"><i class="icon-pencil"></i> 编辑</a> &nbsp;<a
                                    ...
                                    <h4><span class="label label-success"><?php echo L('_BEST_COLLECTION_');?></span>&nbsp; <a target="_blank"
                                            href="<?php echo U('group/index/detail',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a>
                                    </h4>
                                </div>
                                <div class="item-content">
                                    <?php if(($vo["cover"]) != ""): ?><div class="media pull-right">
                                            <a target="_blank" href="<?php echo U('group/index/detail',array('id'=>$vo['id']));?>"><div class="img-thumbnail-wrap"
                                ...
                                <div class="item-footer">
                                    ...
                                    &nbsp;
                                    <a target="_blank" href="<?php echo U('group/index/detail',array('id'=>$vo['id']));?>" class="text-muted"><i class="icon-comments"></i> <?php echo ($vo["reply_count"]); ?></a>&nbsp;
                ...
                <ul class="group-list">
                    <?php if(is_array($groups)): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="clearfix">
                            ...
                            <div class="col-xs-8">
                                ...
                                <p>
                                    <?php echo ($vo["member_count"]); ?> 个<?php echo ((isset($vo["member_alias"]) && ($vo["member_alias"] !== ""))?($vo["member_alias"]):L('_MEMBER_')); ?>&nbsp;&nbsp;
                                    <?php if($vo['flag']): else: ?>
                                        <a data-role="group_attend" data-group-id="<?php echo ($vo["id"]); ?>" class="">+<?php echo L('_JOIN_');?></a><?php endif; ?>
                                </p>
                            </div>
