...
<div id="center_base" class="with-padding" style="padding: 20px">
    <ul class="nav nav-secondary">
        <li class="active"><a href="#base" data-toggle="tab"><?php echo L('_PW_MODIFY_');?></a></li>
     </ul>
    <div class="row">
        <div class="col-xs-8" style="margin-top:20px;">
            <form id="changePasswordForm"  action="<?php echo U('Ucenter/Config/doChangePassword');?>" method="post" class="ajax-form form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <input type="password" class="form-control" id="inputOldPassword" value="" name="old_password" placeholder="<?php echo L('_PW_OLD_INPUT_');?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <input type="password" class="form-control" id="inputNewPassword" value="" name="new_password" placeholder="<?php echo L('_PW_NEW_INPUT_');?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <input type="password" class="form-control" id="inputConfirmPassword" value="" name="confirm_password" placeholder="<?php echo L('_PW_CONFIRM_INPUT_');?>">
                    </div>
                </div>
                <div class="form-group">
