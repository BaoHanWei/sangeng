...
<div class="row ">
    ...
    <div class="row">
        <div class="col-xs-12">
            <p>&nbsp;</p>
            <h4><?php echo L('_MY_FAVORITES_');?></h4>
            <hr class="oneuser-title-hr"/>

            <ul class="nav nav-pills ucenter-tab">
                <li
                <?php if(($type) == "forum"): ?>class="active"<?php endif; ?>
                ><a href="<?php echo U('Ucenter/Collection/index',array('type'=>'forum'));?>">论坛<?php echo L('_COLLECTION_POST_');?></a></li>
                <li
                <?php if(($type) == "group"): ?>class="active"<?php endif; ?>
                ><a href="<?php echo U('Ucenter/Collection/index',array('type'=>'group'));?>">群组<?php echo L('_COLLECTION_POST_');?></a></li>
            </ul>
    ...
    <div style="min-height: 400px;margin-top: 30px;">
        <?php if(!$list): ?><p class="text-muted" style="text-align: center; font-size: 3em;">
            <br><br>
            <?php echo L('_COLLECTION_NONE_'); echo L('_WAVE_');?>
            <br><br><br>
        </p><?php endif; ?>

        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vl): $mod = ($i % 2 );++$i; $user = query_user(array('avatar128','avatar64','nickname','uid','space_url'), $vl['uid']); ?>
            <div class="row">
                ...
                <div class="col-xs-10">
                    ...
                    <p>
                        ...
                        <?php if(($vl["is_top"]) == "2"): ?><i class="post_top"><?php echo L('_ALL_SITE_');?></i>
                            <?php else: ?>
                            <?php if(($vl["is_top"]) == "1"): ?><i class="post_top_forum"><?php echo L('_BOARD_');?></i><?php endif; endif; ?>


                    </p>

                    <p class="pull-right text-muted">
                        <span><?php echo L('_READ_');?>（<?php echo ($vl["view_count"]); ?>）</span>
                        <span style="width: 1em; display: inline-block;">&nbsp;</span>
                        <span><?php echo L('_REPLY_');?>（<?php echo ($vl["reply_count"]); ?>）</span>
                    </p>

                    <p class="text-muted author">
                        <a href="<?php echo ($user["space_url"]); ?>" ucard="<?php echo ($user["uid"]); ?>"><?php echo (op_t($user["nickname"])); ?></a>
                        <?php echo L('_PUBLISH_'); echo L('_COLON_'); echo (friendlydate($vl["create_time"])); ?> |
                        <?php echo L('_REPLY_'); echo L('_COLON_'); echo (friendlydate($vl["last_reply_time"])); ?>
                    </p>
                </div>
            </div>
