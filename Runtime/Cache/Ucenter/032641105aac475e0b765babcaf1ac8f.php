...
<script src="/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link type="text/css" href="/Application/Ucenter/Static/css/blog/blog_catalogs.css" rel="stylesheet">
...
<div class="row ">
    ...
    <div style="min-height: 700px;" class="space-main-wrapper">
       <div class="AdminContent MainForm BlogCatalogManage">
			<form id="CatalogForm" action="<?php echo U('Ucenter/Blog/add_blog_catalogs');?>" method="post">
			    <h3> 添加博客分类 </h3>
			    <label>分类名称：</label><input id="txt_link_name" type="text" name="title" value="" size="20">
			    <label>排序值：</label><input type="text" name="sort" class="catalog_sort" value="" size="5">
			    <span class="submit">
			          <input type="button" value="添加&nbsp;»" tabindex="3" class="BUTTON SUBMIT add_blog_catalog" style="background:#4eaa4c;color:#fff">
			    </span>
			</form>
			<form class="BlogCatalogs">
				...
				<table cellpadding="0" cellspacing="0" border="0">
					<tbody>
						...
						<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="catalog_<?php echo ($vo["id"]); ?>">
								<td class="idx"><?php echo ($vo["sort"]); ?></td>
								<td class="name"><a href="<?php echo U('Ucenter/Blog/edit_blog_catalogs',array('id'=>$vo['id']));?>" title="点击修改博客分类"><?php echo ($vo["title"]); ?></a></td>
								<td class="num"><?php echo ($vo["count"]); ?></td>
								<td class="opts">
									<a href="<?php echo U('Ucenter/Blog/edit_blog_catalogs',array('id'=>$vo['id']));?>" title="点击修改博客分类">修改</a>
									<a href="javascript:;" data-value="<?php echo ($vo["id"]); ?>" class="del_blog_catalog" >删除</a>
								</td>
