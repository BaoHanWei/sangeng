        ...
        <div class="uc_link_info">
            ...
            <?php if(count($fans_default) == 0): ?><p style="text-align: center; font-size: 16px;color:#999999">
        	 ...
        	 <div class="col-xs-9 main-article">
                    ...
                    <?php if(count($rankList) == 0): ?><p class="text-muted" style="text-align: center; font-size: 14px;">
                        <br><br>
                    ...
                    <div style="margin: 20px 0 20px 20px;">
                        <?php if(is_array($rankList)): $i = 0; $__LIST__ = $rankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><div class="row"
                                ...
                                <div class="col-xs-2" style="text-align: center;">
                                    <?php if(!empty($rank["label_content"])): ?><img style="width: 60px;height: 60px" class="rank-icon" src="<?php echo ($rank["logo_url"]); ?>" title="<?php echo ($rank["title"]); ?>" alt="<?php echo ($rank["title"]); ?>"/><?php else: ?><span class="label label-badge rank-label" title="<?php echo ($rank["title"]); ?>" style="background: <?php echo ($rank["label_bg"]); ?> !important;color:<?php echo ($rank["label_color"]); ?> !important;"><?php echo ($rank["label_content"]); ?></span><?php endif; ?>
                                </div>
                                <div class="col-xs-8">
                                    <div>
