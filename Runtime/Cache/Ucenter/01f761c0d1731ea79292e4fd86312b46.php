...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div class="col-xs-12 usercenter">
        <div class="uc">
        	<div class="col-xs-3">
        		<a href="<?php echo U('ucenter/collection/index');?>" class="favorite" id="favorites-pjax">
        	 ...
        	 <div class="col-xs-9 main-article">
        	 		<div class="panels-heading" id="panels-heading-pjax">
				        <nav class="title sub-nav clearfix">
				            ...
				            <a href="<?php echo U('ucenter/index/following',array('uid'=>$user_info['uid']));?>" id="dynamic-tweet" class="active" >关注/粉丝</a>
				            <a href="<?php echo U('ucenter/index/rank',array('uid'=>$user_info['uid']));?>" id="dynamic-discuss">头衔</a>
				        </nav>
				    </div>
                    <div style="margin-top:20px;width:100%">
	                    ...
	                    <?php if(count($following) == 0): ?><p class="text-muted" style="text-align: center; font-size: 3em;">
	                        <br><br>
	                    ...
	                    <div style="margin: 20px 0 20px 20px;">
	                        <?php if(is_array($following)): $i = 0; $__LIST__ = $following;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fan): $mod = ($i % 2 );++$i;?><div class="row"
	                                 style="padding-bottom: 20px;padding-top:20px;margin-left: 0;margin-right: 0">
	                                <div class="col-xs-2">
	                                    <img ucard="<?php echo ($fan["follow_who"]); ?>" style="width: 80px" class="avatar-img" src="<?php echo ($fan["user"]["avatar128"]); ?>"/>
	                                </div>
	                                <div class="col-xs-10">
