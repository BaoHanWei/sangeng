            ...
            <?php if(count($fans_default) == 0): ?><p style="text-align: center; font-size: 16px;color:#999999">
        	 ...
        	 <div class="col-xs-9 main-article">
                    <div style="margin-top:20px;width:100%">
	                    <div class="row">
                        	<div class="way_nav">
								<h3 style="text-align: center;line-height: 30px">申请<?php echo ($rankInfo["title"]); ?>规则</h3>
                        	</div>
                    		<div style="margin-left:20px"><?php echo ($rankInfo["rule_content"]); ?></div>
                    		<div style="text-align: center;margin-top: 40px;">
                    			<a href="<?php echo U('Ucenter/Index/applyExpert',array('rank_id'=>$rankInfo['id']));?>" class="btn btn-default btn-green-border btn-edit no-select"><i class="icon-svg icon-pen-green"></i>提交申请</a>
                    			<a href="<?php echo U('Ucenter/Index/rankVerify');?>" class="btn btn-default btn-green-border btn-edit no-select"><i class="icon-svg icon-pen-green"></i>放弃申请</a>
                    		</div>
                    	</div>
                </div>
             </div>
