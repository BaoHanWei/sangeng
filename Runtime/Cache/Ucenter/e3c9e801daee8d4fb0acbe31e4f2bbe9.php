        	 ...
        	 <div class="col-xs-9 main-article">
        	 		<div class="panels-heading" id="panels-heading-pjax">
				        <nav class="title sub-nav clearfix">
				            <a href="<?php echo U('ucenter/index/applist',array('type'=>Weibo,'uid'=>$user_info['uid']));?>"id="dynamic-all">微博</a>
				            <a href="<?php echo U('ucenter/index/following',array('uid'=>$user_info['uid']));?>" id="dynamic-tweet">关注/粉丝</a>
				            <a href="<?php echo U('ucenter/index/rank',array('uid'=>$user_info['uid']));?>" id="dynamic-discuss" class="active">头衔</a>
				        </nav>
				    </div>
                    <div style="margin-top:20px;width:100%">
                        ...
                        <div class="col-xs-12 uc_fans" style="margin-left: 10px;">
                            <ul class="nav nav-pills ucenter-tab">
                                ...
                                <li <?php if(($tab) == "rankVerifyWait"): ?>class="active"<?php endif; ?>><a href="<?php echo U('Ucenter/Index/rankVerifyWait');?>">
                    ...
                    <?php if(count($rankList) == 0): ?><p class="text-muted"
                        ...
                        <div style="margin: 20px 0 20px 20px;">
                            <form class="form-horizontal center_info ajax-form" role="form"
                                  action="<?php echo U('Ucenter/Index/verify');?>" method="post">
                                <input type="hidden" name="rank_user_id" value="<?php echo ($old_rank_user['id']); ?>">
                                <div class="form-group">
                                   <!--  <label class="col-xs-2 control-label"><?php echo L('_RANK_APPLY_');?></label> -->

                                    <div class="col-xs-10">
                                        <?php if(is_array($rankList)): $i = 0; $__LIST__ = $rankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><div class="col-xs-3 text-center" style="border: 1px solid #eee;background: #f5f5f5;">
                                                <label class="radio-inline" style="padding-left:0px;">
                                                    <attr>
                                                    <p>
                                                       <img style="width: 70px;height:70px" class="rank-icon" src="<?php echo ($rank["logo_url"]); ?>" title="<?php echo ($rank["title"]); ?>" alt="<?php echo ($rank["title"]); ?>"/>
                                                    </p>
                                                    <p> 
                                                    <!-- <input type="radio" name="rank_id" value="<?php echo ($rank["id"]); ?>" <?php if($rank['id'] == $old_rank_user['rank_id']): ?>checked<?php endif; ?>> --><span class="label label-badge rank-label" title="<?php echo ($rank["title"]); ?>" style="background: <?php echo ($rank["label_bg"]); ?> !important;color:<?php echo ($rank["label_color"]); ?> !important;"><?php echo ($rank["label_content"]); ?></span></p>
                                                    <p><?php if($rank['id'] == $old_rank_user['rank_id']): ?><a href="javascript:;" class="apply"><?php echo L('_APPLY_');?></a><?php else: ?><a href="<?php echo U('Ucenter/Index/verifyRule',array('rank_id'=>$rank[id]));?>" class="apply"><?php echo L('_APPLY_');?></a><?php endif; ?></p>
                                                    </attr>
                                ...
                                <!-- <div class="form-group">
                                    <label for="reason" class="col-xs-2 control-label"><?php echo L('_RANK_APPLY_REASON_');?></label>

                                    <div class="col-xs-10">
                                        <textarea id="reason" name="reason" class="form-control" style="width: 100%; height: 6em;resize: none"><?php echo ($old_rank_user['reason']); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-xs-10">
                                        <button type="submit" class="btn btn-primary"><?php echo L('_APPLY_');?></button>
                                    </div>
                                </div> -->
                            </form>
                        </div><?php endif; ?>
