                    ...
                    <div id="frm-post-popup " class="white-popup1 col-xs-12" style="margin-top:50px;">
                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-xs-9">
                                    <form class="form-horizontal ajax-form" role="form" action="<?php echo U('Ucenter/Index/columnEdit');?>" method="post">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-xs-8">
                                                <input id="title" name="project_name" class="form-control form_check" check-type="Text" value="<?php echo ($data["project_name"]); ?>" placeholder="专栏名称"/>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-5">
                                                <select id="category" name="category" class="form-control">
                                                    <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): $mod = ($i % 2 );++$i;?><option value="<?php echo ($top["id"]); ?>" <?php if(($data['category']) == $top['id']): ?>selected<?php endif; ?>>
                                                            <?php $title=explode('_',$top['title']);echo $title[0]; ?>
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-xs-10">
                                                <textarea id="description" name="description" class="form-control" style="height:180px;" placeholder="简单描述下专栏内容,不能超过500字"><?php echo ($data["description"]); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
