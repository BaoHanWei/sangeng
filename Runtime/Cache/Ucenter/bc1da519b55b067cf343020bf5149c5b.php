    ...
    <div id="center">
        <div id="center_base">
            <ul class="nav nav-secondary">
                <li class="active"><a href="#base" data-toggle="tab"><?php echo L('_SCORE_MY_');?></a></li>
                <li>
                    <a href="#level" data-toggle="tab"><?php echo L('_GRADE_EXPERIENCE_');?></a>
                </li>
                <li>
                    <a href="#rule" data-toggle="tab"><?php echo L('_SCORE_RULE_');?></a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="base">
                    <div class="with-padding" style="padding: 20px">
                        <div class="col-xs-8">
                            <div class="panel">
                                <div class="panel-heading"><?php echo L('_SCORE_NOW_');?></div>
                                <ul class="list-group">
                                    <?php if(is_array($scores)): $i = 0; $__LIST__ = $scores;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-group-item"><?php echo ($vo["title"]); ?>：<?php echo ($vo["value"]); ?> <?php echo ($vo["unit"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="level">
                    <div class="with-padding" style="padding: 20px">
                        <div class="col-xs-8">
                            <div class="panel">
                                <div class="panel-heading"><?php echo L('_EXPERIENCE_UPGRADE_');?></div>
                                <ul class="list-group">
                                    <li class="list-group-item" style="line-height: 40px;"><?php echo ($level); ?></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div>
                                <?php echo L('_EXPERIENCE_NOW_'); echo L('_COLON_'); echo ($self["score"]); ?>
                            </div>
                            <div><?php echo L('_GRADE_NOW_'); echo L('_COLON_'); echo ($self["title"]); ?></div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="rule">
                    <div class="with-padding" style="padding: 20px">
                        <?php if(is_array($action_module)): $i = 0; $__LIST__ = $action_module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?><div class="panel">
                                <div class="panel-heading"><?php echo ((isset($m["module"]["alias"]) && ($m["module"]["alias"] !== ""))?($m["module"]["alias"]):L('_SYSTEM_')); ?></div>
                                <div class="list-group">
                                    <?php if(is_array($m["action"])): $i = 0; $__LIST__ = $m["action"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['rule_array'] != false): ?><a class="list-group-item"><h4 class="list-group-item-heading"><strong><?php echo ($vo["title"]); ?>：</strong></h4>
                                                <?php if(is_array($vo["rule_array"])): $i = 0; $__LIST__ = $vo["rule_array"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><p class="list-group-item-text">
                                                        <?php echo L('_PER_TIMES_'); echo L('_BRACKETS_LEFT_'); echo ($r["score"]["title"]); echo L('_BRACKETS_RIGHT_'); echo L('_BRACKETS_LEFT_'); echo ($r["rule"]); echo L('_BRACKETS_RIGHT_'); echo ($r["score"]["unit"]); ?>
                                                        <?php echo L('_COMMA_'); echo L('_PER_'); echo L('_BRACKETS_LEFT_'); echo ($r["cycle"]); echo L('_BRACKETS_RIGHT_'); echo L('__HOUR_MOST_'); echo L('_BRACKETS_LEFT_'); echo ($r["max"]); echo L('_BRACKETS_RIGHT_'); echo L('_TIMES_');?></p><?php endforeach; endif; else: echo "" ;endif; ?>
