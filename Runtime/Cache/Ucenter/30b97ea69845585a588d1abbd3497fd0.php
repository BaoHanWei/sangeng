        	 ...
        	 <div class="col-xs-9 main-article">
        	 		<div class="panels-heading" id="panels-heading-pjax">
				        <nav class="title sub-nav clearfix">
				            <a href="<?php echo U('ucenter/index/applist',array('type'=>Weibo,'uid'=>$user_info['uid']));?>" class="active" id="dynamic-all">微博</a>
                    ...
                    <?php echo W($module.'/UcenterBlock/render',array('uid'=>$user_info['uid'],'page'=>$page,'tab'=>$tab,'stab'=>$stab));?>
             </div>
