        ...
        <div class="col-xs-8 ">
            <div class="common-block ">
                <header class="clearfix ">
                    <div class="pull-left bottom-line">微博<?php echo L('_DETAIL_');?></div>
                ...
                <section>
                    ...
                    <div style="float:left;">
                    	<a href="<?php echo ($user_info["space_url"]); ?>"><img src="<?php echo ($user_info["avatar64"]); ?>" class="avatar-img img-responsive top_img"/></a>
                    	<a href="<?php echo ($user_info["space_url"]); ?>" class="user" style="display: block;text-align: center;width: 100%;margin-top: 5px;"><?php echo (htmlspecialchars($user_info["nickname"])); ?></a>
                    	</div>
                        <div class="row" id="weibo_<?php echo ($weibo["id"]); ?>" style="float:left;width:90%">
                            <div class="col-xs-12">
...
<div class="col-xs-4" style="padding: 0px" ><span style="display:block;font-size:12px;color:#737373" class="cpointer" data-role="weibo_comment_btn"  data-weibo-id="<?php echo ($weibo["id"]); ?>">
    <?php echo L('_COMMENT_');?> <?php echo ($weiboCommentTotalCount); ?>
                                            ...
                                            <?php if($weibo['can_delete']): ?><a data-weibo-id="<?php echo ($weibo["id"]); ?>" title="<?php echo L('_DELETE_');?>" data-role="del_weibo" style="padding-left:10px;">
                                                    删除
                                                </a><?php endif; ?>
                                        </div>
                                    </div>
