        ...
        <div class="row" style="padding: 10px 10px 0 0 ">
            <div class="col-xs-12">
                <div class="event_header_title">
                    <div class="pull-left"><?php echo L('_MY_EVENT_');?></div>
                    <div class="btn-group btn-group-sm  pull-right" style="margin-bottom:5px;">
                        <a href="<?php echo U('myevent',array('lora'=>'','type_id'=>$type_id));?>"
                           class="btn btn-default <?php if($lora == ''): ?>active<?php endif; ?>"><?php echo L('_MY_SPONSOR_');?></a>
                        <a href="<?php echo U('myevent',array('lora'=>'attend','type_id'=>$type_id));?>"
                           class="btn btn-default <?php if($lora == 'attend'): ?>active<?php endif; ?>"><?php echo L('_MY_IN_');?></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="pull-left col-xs-7">
                        ...
                        <div class="event_fq_count pull-left">
                            ...
                            <div class="pull-left mgb10">
                                <div class="pull-left mgl20 " style="font-size: 14px;"><?php echo L('_TIME_'); echo L('_COLON_');?>
                            ...
                            <div class="pull-left mgb10">
                                <div class="pull-left mgl20 " style="font-size: 14px;"><?php echo L('_REGISTRATION_TIME_DEADLINE_'); echo L('_COLON_');?>
                                    <?php echo date('Y-m-d',$vo['deadline']);?> &nbsp;&nbsp;

                                </div>
                            </div>
                            <div class="word-wrap pull-left mgl20 event_short_explain" style="width: 80%"><?php echo L('_INTRO_'); echo L('_COLON_');?>
                                    ...
                                    <?php if(($vo['uid'] != is_login())): if(!$vo['check_isSign']){ ?>
                                        ...
                                        <?php if(is_login() == 0): ?><a class="btn btn-info  " href="javascript:" style="color: #fff"
                                            ...
                                            <?php if(check_auth('Event/Index/doSign')): ?><a class="btn btn-primary event_sign " style="color: #fff"
                                                   href="<?php echo U('ajax_sign',array('event_id'=>$vo['id']));?>"><?php echo L('_REGISTER_OP_');?> </a><?php endif; endif; ?>
                                        <?php } ?>
                                        <?php }else{ ?>
            ...
            <div class="row issue_list">
                ...
                <?php if(count($contents) == 0): ?><div style="font-size:1em;padding:2em 0;color: #ccc;text-align: center"><?php echo L('_TIP_EMPTY_');?></div><?php endif; ?>
