                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="inputTitle" class="col-sm-2 control-label">*<?php echo L('_GROUP_NAME_');?></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="title" class="form-control" id="inputTitle" placeholder="<?php echo L('_PLACE_HOLDER_GROUP_NAME_');?>" value="<?php echo ($group["title"]); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="group_type" class="form-control" id="inputType">
                                            ...
                                            <?php if(is_array($groupTypeAll)): $i = 0; $__LIST__ = $groupTypeAll;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$groupType): $mod = ($i % 2 );++$i;?><option <?php if($group['type_id'] == $groupType['id']): ?>selected<?php endif; ?> value="<?php echo ($groupType['id']); ?>"><?php echo ($groupType['title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                ...
                                <div class="form-group">
                                    <label for="inputDescription" class="col-sm-2 control-label"><?php echo L('_GROUP_INTRO_');?></label>
                                    <div class="col-sm-10">
                                        <textarea name="detail" class="form-control" id="inputDescription" placeholder="<?php echo L('_PLACE_HOLDER_GROUP_INTRO_');?>" ><?php echo ($group["detail"]); ?></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="inputDescription" class="col-sm-2 control-label"><?php echo L('_GROUP_TYPE_');?></label>
                                    <div class="col-sm-10">
                                        <label for="id_type_0" style="font-weight: normal">
                                        <input id="id_type_0" name="type" value="0" type="radio" <?php if($group['type'] == 0): ?>checked<?php endif; ?> >
                                           <?php echo L('_PUBLIC_GROUP_');?>
                                        </label>
                                        <label for="id_type_1" style="font-weight: normal">
                                        <input id="id_type_1" name="type" value="1" type="radio" <?php if($group['type'] == 1): ?>checked<?php endif; ?>>
                                            <?php echo L('_PRIVATE_GROUP_');?>
                                        </label>
                                        <div style="color: #999">
                                            <?php echo L('_TIP_IN_GROUP_');?>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><?php echo L('_GROUP_IMAGE_');?></label>
                                    <div  class="col-sm-10">

                                        <?php echo W('Common/UploadImage/render',array(array('id'=>'cover_id_cover','name'=>'logo','value'=>$group['logo'],'width'=>200,'height'=>200,'isLoadScript'=>1)));?>
                                ...
                                <!--<div class="form-group">
                                    ...
                                    <div  class="col-sm-10">
                                        <?php echo W('Common/UploadImage/render',array(array('id'=>'background','name'=>'background','value'=>$group['background'],'width'=>200,'height'=>200,'isLoadScript'=>1)));?>
                                    </div>
                                </div>-->
                                <div class="form-group">
                                    <label for="inputTitle" class="col-sm-2 control-label">*<?php echo L('_GROUP_MEMBER_ALIAS_');?></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="member_alias" class="form-control" id="inputMember" placeholder="<?php echo L('_PLACE_HOLDER_ALIAS_');?>" value="<?php echo ($group["member_alias"]); ?>">
                                    </div>
                                </div>
