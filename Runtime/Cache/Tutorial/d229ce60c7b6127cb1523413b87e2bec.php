    ...
    <div id="wrapper">
	    <div id="navsecond">
			...
			<ul>
	            ...
	            <?php if(is_array($parent)): $i = 0; $__LIST__ = $parent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><li class="design"><a href="<?php echo U('tutorials',array('cate'=>$type['id']));?>" data-id="<?php echo ($type['id']); ?>" class="ptype <?php if( $group_cate == $type['id']): ?>active<?php endif; ?>">
	                <?php echo ($type["title"]); ?>
		...
		<div id="project-content">
			<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="pro-list" style="display: block;">
			    <div class="item-title">
			      <h2><?php echo ($vo["title"]); ?></h2></div>
			    <div class="pro-list-content">
				  <?php if($vo['list'] != null): if(is_array($vo["list"])): $i = 0; $__LIST__ = $vo["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="pro-item">
				        <a href="<?php echo U('tutorial/index/tutorial',array('id'=>$val['id']));?>" title="<?php echo ($val["title"]); ?>">
				          <div class="pro-item-img">
				            <img src="<?php echo (getthumbimagebyid($val["logo"],300,300)); ?>" alt="<?php echo ($val["title"]); ?>" title="<?php echo ($val["title"]); ?>"></div>
