        ...
        <div class="col-xs-12">
            <section id="contents">
                ...
                <?php if(is_array($list_top)): $i = 0; $__LIST__ = $list_top;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$document): $mod = ($i % 2 );++$i;?><a class="group-list-title-link" title="<?php echo (htmlspecialchars($document["title"])); ?>" href="<?php echo U('Index/detail',array('id'=>$document['id']));?>">
                        ...
                        <img src="/Application/Tutorial/Static/images/is_top.png">
                    </a>
...
<div class="clearfix fourm-posts common_block_border">
    <div class="clearfix group_block_title" style="font-size: 14px;padding: 1px 5px">
        <div class="group_tab pull-left">
            <ul id="" class="nav nav-tabs" role="tablist">
                ...
                ><a href="<?php echo U('group',array('type'=>'post','id'=>$group_id));?>">概要</a></li>
                <li
                <?php if($type == 'new'): ?>class="active"<?php endif; ?>
                ><a href="<?php echo U('group',array('type'=>'new','id'=>$group_id));?>">目录</a></li>
                <li
    ...
    <?php }elseif($type == 'post'){ ?>
        <div class="">
            <div class="col-xs-12">
                <section id="contents">
                    <?php if(!$tutorial['detail']): ?><div class="row">
                            <div class="col-xs-12">
                    ...
                    <p class="book-content" style="font-size:14px;"><?php echo ($tutorial["detail"]); ?></p>
                    <div class="pull-right">
                        <?php echo getPagination($totalCount,$r);?>
                    </div>
                </section>
