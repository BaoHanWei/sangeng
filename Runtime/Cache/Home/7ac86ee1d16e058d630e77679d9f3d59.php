<?php if (!defined('THINK_PATH')) exit();?><div id="sub_nav">
    <nav class="navbar navbar-default" role="navigation">
        <div class="container" style="width:1180px;">
            <a href="<?php echo U($MODULE_INFO['entry']);?>" class="navbar-brand logo" style=""><!-- <i class="icon-<?php echo ($brand["icon"]); ?>"></i> --> 
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-7">
                    <ul class="nav navbar-nav" style="height:100px;margin-left:-260px;">
